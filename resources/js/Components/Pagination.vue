            ...
            <div>
                <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                    ...
                    <Link
                        ...
                        href="#"
                        :class="{
                            'bg-indigo-600 cursor-pointer text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 px-4 py-2 ': link.active,
                            'relative cursor-pointer first-of-type:rounded-l-md last-of-type:rounded-r-md  inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0': !link.active,
                        }"
                        v-html="link.label"
                        preserve-scroll
                    >
