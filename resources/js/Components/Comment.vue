<template>
    <div class="sm:flex">
        ...
        <div class="flex-1">
            ...
            <span class="first-letter:uppercase block pt-1 text-xs text-gray-600">By {{ comment.user.name }} {{ relativeDate(comment.created_at)}} | <span>{{comment.likes_count}} likes</span></span>
