    ...
    <Container>
      ...
      <div class="mt-4">
        ...
        <div v-if="$page.props.auth.user" class="mt-2">
          <Link
            ...
            class="text-sm inline-block bg-indigo-600 hover:bg-pink-500 transition-colors text-white py-1.5 px-3 rounded-full"
            method="post">
      ...
      <div class="mt-12">
        ...
        <form v-if="$page.props.auth.user"
              @submit.prevent="() => commentIdBeingEdited ? updateCommnent() : addComment()">
          <div>
            <InputLabel for="body" class="sr-only">Comment</InputLabel>
            <MarkdownEditor v-model="commentForm.body" class="min-h-[100px]" ref="commentEditorRef"
                            placeholder="Speak your mind Spoc..."/>
